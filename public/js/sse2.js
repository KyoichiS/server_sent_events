...
//
function funcSubmit() {
  return _funcSubmit.apply(this, arguments);
}
/*
/////////////////
...
function _funcSubmit() {
  _funcSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var token, txtInput, frmData, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            txtInput = document.querySelector('#textName');
...
function _receiveMessage() {
  _receiveMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(requestid) {
    var eventURL;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            eventURL = '/sse?requestid=' + requestid;
